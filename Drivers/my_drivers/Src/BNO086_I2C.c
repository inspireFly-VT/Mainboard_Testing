...
//A monotonically incrementing uint8_t that rolls over. It is used to detec
...
// Calculate roll, pitch, and yaw
    rpy.Pitch = atan2f(2.0f * (q2q3 + q1q4), q1q1 + q2q2
    rpy.Roll  = -asinf(2.0f * (q2q4 - q1q3));
    rpy.Yaw   = atan2f(2.0f * (q1q2 + q3q4), q1q1 - q2q2
// Convert to degrees
    rpy.Pitch *= _180_DIV_PI;
    rpy.Roll  *= _180_DIV_PI;
    rpy.Yaw   *= _180_DIV_PI;
// Normalize yaw to the [0, 360) range
    rpy.Yaw = (rpy.Yaw >= 0.0f) ? 360.0f - rpy.Yaw : -rpy
// Normalize pitch to the [-180, 180] range
    rpy.Pitch = (rpy.Pitch >= 0.0f) ? 180.0f - rpy.Pitch
}
#endif
...
if (HAL_I2C_Master_Transmit_DMA(&hi2c1, BNO_W_ADDR
...
#else
if (HAL_I2C_Master_Transmit(&hi2c1, BNO_W_ADDR, bufferIO
return HAL_ERROR; // Return error if transmission fails
}
#endif
delay_us(RESET_DELAY); // Delay 100 microseconds before next I2C trans
return HAL_OK;
}
...
// First, receive the header (4 bytes) to determine the full packet siz
#ifdef USE_I2C_DMA
//i2c1_transfer_complete = 0;  // Reset DMA transfer complete flag
if (HAL_I2C_Master_Receive_DMA(&hi2c1, BNO_R_ADDR
...
while (HAL_I2C_GetState(&hi2c1) != HAL_I2C_STATE_READY
#else
if (HAL_I2C_Master_Receive(&hi2c1, BNO_R_ADDR, bufferIO
...
delay_us(RESET_DELAY); // Delay 100 microseconds before receiving the
...
#endif
delay_us(RESET_DELAY); // Delay 100 microseconds after receiving the p
return HAL_OK;
}
...
//bufferIO - 10 Sequence number increments once for each report sent. Gaps
//bufferIO - 11 Status bits 7-5: reserved, 4-2: exponent delay, 1-0: Accura
...
sensorData.SenVal.RawAccelerometer.X = *(int16_t
sensorData.SenVal.RawAccelerometer.Y = *(int16_t
sensorData.SenVal.RawAccelerometer.Z = *(int16_t
sensorData.SenVal.RawAccelerometer.TimeStamp
break;
#endif
#ifdef ACCELEROMETER
case ACCELEROMETER:
sensorData.SenVal.Accelerometer.X = (float)(*
sensorData.SenVal.Accelerometer.Y = (float)(*
sensorData.SenVal.Accelerometer.Z = (float)(*
break;
#endif
#ifdef LINEAR_ACCELERATION
case LINEAR_ACCELERATION:
sensorData.SenVal.LinearAcceleration.X = (float
sensorData.SenVal.LinearAcceleration.Y = (float
sensorData.SenVal.LinearAcceleration.Z = (float
break;
#endif
#ifdef GRAVITY
case GRAVITY:
sensorData.SenVal.Gravity.X = (float)(*(int16_t
sensorData.SenVal.Gravity.Y = (float)(*(int16_t
sensorData.SenVal.Gravity.Z = (float)(*(int16_t
break;
#endif
#ifdef RAW_GYROSCOPE
case RAW_GYROSCOPE:
sensorData.SenVal.RawGyroscope.X = *(int16_t
sensorData.SenVal.RawGyroscope.Y = *(int16_t
sensorData.SenVal.RawGyroscope.Z = *(int16_t
sensorData.SenVal.RawGyroscope.Temperature =
sensorData.SenVal.RawGyroscope.TimeStamp = *(
break;
#endif
#ifdef GYROSCOPE_CALIBRATED
case GYROSCOPE_CALIBRATED:
sensorData.SenVal.Gyroscope.X = (float)(*(int16_t
sensorData.SenVal.Gyroscope.Y = (float)(*(int16_t
sensorData.SenVal.Gyroscope.Z = (float)(*(int16_t
break;
#endif
#ifdef GYROSCOPE_UNCALIBRATED
case GYROSCOPE_UNCALIBRATED:
sensorData.SenVal.GyroscopeUncal.X = (float)(
sensorData.SenVal.GyroscopeUncal.Y = (float)(
sensorData.SenVal.GyroscopeUncal.Z = (float)(
sensorData.SenVal.GyroscopeUncal.BiasX = (float
sensorData.SenVal.GyroscopeUncal.BiasY = (float
sensorData.SenVal.GyroscopeUncal.BiasZ = (float
break;
#endif
#ifdef RAW_MAGNETOMETER
case RAW_MAGNETOMETER:
sensorData.SenVal.RawMagnetometer.X = *(int16_t
sensorData.SenVal.RawMagnetometer.Y = *(int16_t
sensorData.SenVal.RawMagnetometer.Z = *(int16_t
sensorData.SenVal.RawMagnetometer.TimeStamp =
break;
#endif
#ifdef MAGNETIC_FIELD_CALIBRATED
case MAGNETIC_FIELD_CALIBRATED:
sensorData.SenVal.MagneticField.X = (float)(*
sensorData.SenVal.MagneticField.Y = (float)(*
sensorData.SenVal.MagneticField.Z = (float)(*
break;
#endif
#ifdef MAGNETIC_FIELD_UNCALIBRATED
case MAGNETIC_FIELD_UNCALIBRATED:
sensorData.SenVal.MagneticFieldUncal.X = (float
sensorData.SenVal.MagneticFieldUncal.Y = (float
sensorData.SenVal.MagneticFieldUncal.Z = (float
...
#ifdef USE_FOR_TELESCOPE
sensorData.SenVal.RotationVector.I = (float)(
sensorData.SenVal.RotationVector.J = (float)(
sensorData.SenVal.RotationVector.K = (float)(
sensorData.SenVal.RotationVector.Real = (float
...
sensorData.SenVal.GameRotationVector.I = (float
sensorData.SenVal.GameRotationVector.J = (float
sensorData.SenVal.GameRotationVector.K = (float
sensorData.SenVal.GameRotationVector.Real = (
break;
#endif
#ifdef GEOMAGNETIC_ROTATION_VECTOR
case GEOMAGNETIC_ROTATION_VECTOR:
sensorData.SenVal.GeoMagRotationVector.I = (float
sensorData.SenVal.GeoMagRotationVector.J = (float
sensorData.SenVal.GeoMagRotationVector.K = (float
...
#ifdef PRESSURE
case PRESSURE:
sensorData.SenVal.Pressure = (float)(*(int32_t
break;
#endif
#ifdef AMBIENT_LIGHT
case AMBIENT_LIGHT:
sensorData.SenVal.AmbientLight = (float)(*(int32_t
break;
#endif
#ifdef HUMIDITY
case HUMIDITY:
sensorData.SenVal.Humidity = (float)(*(int16_t
break;
#endif
#ifdef PROXIMITY
case PROXIMITY:
sensorData.SenVal.Proximity = (float)(*(int16_t
break;
#endif
#ifdef TEMPERATURE
case TEMPERATURE:
sensorData.SenVal.Temperature = (float)(*(int16_t
break;
#endif
#ifdef RESERVED
case RESERVED:
sensorData.SenVal.Reserved = (float)(*(int16_t
break;
#endif
#ifdef TAP_DETECTOR
case TAP_DETECTOR:
sensorData.SenVal.TapDetectorFlag = bufferIO[
break;
#endif
#ifdef STEP_DETECTOR
case STEP_DETECTOR:
sensorData.SenVal.StepDetectorLatency = *(uint32_t
break;
#endif
#ifdef STEP_COUNTER
case STEP_COUNTER:
sensorData.SenVal.StepCounter.Latency = *(uint32_t
sensorData.SenVal.StepCounter.Steps = *(uint32_t
break;
#endif
#ifdef SIGNIFICANT_MOTION
case SIGNIFICANT_MOTION:
sensorData.SenVal.SignificantMotion = *(uint16_t
break;
#endif
#ifdef STABILITY_CLASSIFIER
case STABILITY_CLASSIFIER:
sensorData.SenVal.StabilityClassifier = bufferIO
break;
#endif
#ifdef SHAKE_DETECTOR
case SHAKE_DETECTOR:
sensorData.SenVal.ShakeDetector = *(uint16_t
break;
#endif
#ifdef FLIP_DETECTOR
case FLIP_DETECTOR:
sensorData.SenVal.FlipDetector = *(uint16_t *
break;
#endif
#ifdef PICKUP_DETECTOR
case PICKUP_DETECTOR:
sensorData.SenVal.PickupDetector = *(uint16_t
break;
#endif
#ifdef STABILITY_DETECTOR
case STABILITY_DETECTOR:
sensorData.SenVal.StabilityDetector = *(uint16_t
break;
#endif
#ifdef PERSONAL_ACTIVITY_CLASSIFIER
case PERSONAL_ACTIVITY_CLASSIFIER:
sensorData.SenVal.PersonalActivityClassifier.
sensorData.SenVal.PersonalActivityClassifier.
sensorData.SenVal.PersonalActivityClassifier.
...
#ifdef TILT_DETECTOR
case TILT_DETECTOR:
sensorData.SenVal.TiltDetector = *(uint16_t *
break;
#endif
#ifdef POCKET_DETECTOR
case POCKET_DETECTOR:
sensorData.SenVal.PocketDetector = *(uint16_t
break;
#endif
#ifdef CIRCLE_DETECTOR
case CIRCLE_DETECTOR:
sensorData.SenVal.CircleDetector = *(uint16_t
break;
#endif
#ifdef HEART_RATE_MONITOR
case HEART_RATE_MONITOR:
sensorData.SenVal.HeartRateMonitor = *(uint16_t
break;
#endif
#ifdef ARVR_STABILIZED_RV
case ARVR_STABILIZED_RV:
sensorData.SenVal.ArVrStabilizedRV.I = (float
sensorData.SenVal.ArVrStabilizedRV.J = (float
sensorData.SenVal.ArVrStabilizedRV.K = (float
sensorData.SenVal.ArVrStabilizedRV.Real = (float
sensorData.SenVal.ArVrStabilizedRV.Accuracy =
break;
#endif
#ifdef ARVR_STABILIZED_GRV
case ARVR_STABILIZED_GRV:
sensorData.SenVal.ArVrStabilizedGRV.I = (float
sensorData.SenVal.ArVrStabilizedGRV.J = (float
sensorData.SenVal.ArVrStabilizedGRV.K = (float
sensorData.SenVal.ArVrStabilizedGRV.Real = (float
break;
#endif
#ifdef GYRO_INTEGRATED_RV
case GYRO_INTEGRATED_RV:
sensorData.SenVal.GyroIntegratedRV.I = (float
sensorData.SenVal.GyroIntegratedRV.J = (float
sensorData.SenVal.GyroIntegratedRV.J = (float
sensorData.SenVal.GyroIntegratedRV.Real = (float
...
sensorData.SenVal.IzroRequest.Intent = (BNO_IZroMotionIntent_t
sensorData.SenVal.IzroRequest.Request = (BNO_IZroMotionRequest_
break;
#endif
#ifdef RAW_OPTICAL_FLOW
case RAW_OPTICAL_FLOW:
sensorData.SenVal.RawOptFlow.Dx = *(int16_t *
sensorData.SenVal.RawOptFlow.Dy = *(int16_t *
sensorData.SenVal.RawOptFlow.Iq = *(int16_t *
sensorData.SenVal.RawOptFlow.ResX = bufferIO[
sensorData.SenVal.RawOptFlow.ResY = bufferIO[
sensorData.SenVal.RawOptFlow.Shutter = bufferIO
sensorData.SenVal.RawOptFlow.FrameMax = bufferIO
sensorData.SenVal.RawOptFlow.FrameAvg = bufferIO
sensorData.SenVal.RawOptFlow.FrameMin = bufferIO
sensorData.SenVal.RawOptFlow.LaserOn = bufferIO
sensorData.SenVal.RawOptFlow.Dt = *(int16_t *
sensorData.SenVal.RawOptFlow.TimeStamp = *(int32_t
break;
#endif
#ifdef DEAD_RECKONING_POSE
case DEAD_RECKONING_POSE:
sensorData.SenVal.DeadReckoningPose.TimeStamp
...
sensorData.SenVal.DeadReckoningPose.I = (float
sensorData.SenVal.DeadReckoningPose.J = (float
sensorData.SenVal.DeadReckoningPose.K = (float
sensorData.SenVal.DeadReckoningPose.Real = (float
...
#ifdef WHEEL_ENCODER
case WHEEL_ENCODER:
sensorData.SenVal.WheelEncoder.TimeStamp = *(
sensorData.SenVal.WheelEncoder.WheelIndex = bufferIO
sensorData.SenVal.WheelEncoder.DataType = bufferIO
sensorData.SenVal.WheelEncoder.Data = *(int16_t
break;
#endif
}
}
...
break;
#endif
case COMMAND_UNSOLICITED_INITIALIZE: // 0x84 – Initialize (unsolici
...
calibrationStatus = *(BNO_calibrationStat_t *
return HAL_OK;
break;
...
cmdResponse = *(BNO_CommandResp_t *)&bufferIO
return processCommandResponse();
break;
case REPORT_FRS_READ_RESPONSE: // 0xF3
frsReadResponse = *(BNO_FrsReadResp_t *)&bufferIO
return HAL_OK;
break;
case REPORT_FRS_WRITE_RESPONSE: // 0xF5
frsWriteResponse = *(BNO_FrsWriteResp_t *)&bufferIO
return HAL_OK;
break;
...
sensorFeartures = *(BNO_Feature_t *)&bufferIO
return HAL_OK;
break;
...
if((bufferIO[2] == receiveChannel) && (bufferIO
...
// During reset or power-on sequence, the bootloader first checks the statu
// If the pin is pulled low during reset or poweron, the BNO08X will enter
// If the BOOTN pin is pulled high, then the bootloader starts the applicat
...
if(waitInt()) {
if(BNO_Reset() == HAL_OK) {
// Finally, we want to interrogate the device about its
BNO_On();
return getID();
}
}
...
const uint32_t reportIntervalUs = 200000; // 200 ms = 200,000 microsec
// Enable high accuracy for the accelerometer, gyroscope, and magnetome
if (BNO_condigureCalibration(CALIBRATE_ACCEL_GYRO_MAG
// Set high accuracy mode for the Magnetometer (MAGNETIC_FIELD_CALI
if (BNO_setFeature(MAGNETIC_FIELD_CALIBRATED, reportIntervalUs
// Set high accuracy mode for the Rotation Vector
if (BNO_setFeature(ROTATION_VECTOR, reportIntervalUs
// Optionally: Set high accuracy for the accelerometer, gyr
// Uncomment these if you need high accuracy on other senso
if (BNO_setFeature(ACCELEROMETER, reportIntervalUs
if (BNO_setFeature(GYROSCOPE_CALIBRATED, reportIntervalUs
...
// When sleep command is issued all sensors that are configured as always o
...
HAL_StatusTypeDef BNO_writeFRS(const uint16_t length, const
...
switch(status) {
// Check for errors: Unrecognized FRS type, Busy, Out of range,
...
bufferIO[5] = cmdSeqNo++;
bufferIO[6] = COMMAND_ERRORS; // 0x01 – report all errors in the error
//bufferIO[7] = 0; // he severity of errors to report. Errors of this s
if(waitForCommandResponse() == HAL_OK) {
...
//This command instructs SH-2 to persist the results of the last tare opera
...
// This command instructs SH-2 to set the current run-time sensor reorienta
// The rotation vector is a signed, 16-bit 2’s-complement fixed point numbe
HAL_StatusTypeDef BNO_TareSetReorientation(const double X
resetHeader(REPORT_COMMAND_REQUEST);
bufferIO[5] = cmdSeqNo++;
bufferIO[6] = COMMAND_TARE; // 0x03 – Tare command
...
#endif
// The sensor hub responds to the Initialize command with an Initialize Res
// where the sensor hub reinitializes itself, this response is unsolicited.
// also generated after startup
HAL_StatusTypeDef BNO_Initialize(void) {
resetHeader(REPORT_COMMAND_REQUEST);
bufferIO[5] = cmdSeqNo++;
bufferIO[6] = COMMAND_INITIALIZE; // 0x04 – Initialize command
bufferIO[7] = COMMAND_INITIALIZE_RESET; //1 Reinitialize the entire sen
return waitForCommandResponse();
}
...
// magnetometer giving the host the ability to control when calibration is
...
bufferIO[11] = 1; // Planar Accel Cal Enable (1 – enabled, 0 –
break;
case CALIBRATE_ON_TABLE:
bufferIO[12] = 1; // On Table Cal Enable (1 – enabled, 0 – disa
break;
case CALIBRATE_ACCEL_GYRO_MAG:
bufferIO[7] = bufferIO[8] = bufferIO[9] = 1;
break;
case CALIBRATE_ALL:
bufferIO[7] = bufferIO[8] = bufferIO[9] = bufferIO
break;
}
...
// This command is sent by the host to request the enable/disable state of
...
// The Configure Periodic DCD Save command configures the automatic saving
// no response to this command. This command does not inhibit the Save DCD
// 0 Enable, 1 Disable
HAL_StatusTypeDef BNO_configurePeriodicDcdSave(const uint8_t
resetHeader(REPORT_COMMAND_REQUEST);
bufferIO[5] = cmdSeqNo++;
bufferIO[6] = COMMAND_DCD_PERIOD_SAVE; // 0x09 Configure Periodic DCD S
bufferIO[7] = enableStatus;
return sendPacket(CHANNEL_CONTROL);
}
// The Get Oscillator Type command is used to get information about the osc
...
resetHeader(REPORT_COMMAND_REQUEST);
bufferIO[5] = cmdSeqNo++;
bufferIO[6] = COMMAND_TURNTABLE_CAL; // 0x0C – Turntable Calibratio
//bufferIO[7] = 0x00; // 0x00 – Start Calibration
*(uint32_t *)&bufferIO[8] = usInterval;
if(waitForCommandResponse() == HAL_OK) {//CHANNEL_CONTROL, REPORT_C
if(!calibrationStatus.Status) {
uint32_t endCalibrationTime = HAL_GetTick
while(HAL_GetTick() < endCalibrationTime)
// Stop the calibration and get response
resetHeader(REPORT_COMMAND_REQUEST);
bufferIO[5] = cmdSeqNo++;
bufferIO[6] = COMMAND_TURNTABLE_CAL; // 0x0C – Turntable Ca
...
// ToDo Check functionality Not getting a reponce to start
// The bootloader operating mode request is used to request various operati
HAL_StatusTypeDef BNO_setBootMode(const BNO_BootMode_t mode
resetHeader(REPORT_COMMAND_REQUEST);
bufferIO[5] = cmdSeqNo++;
bufferIO[6] = COMMAND_BOOTLOADER; // 0x0D – Bootloader command
bufferIO[7] = COMMAND_BOOTLOADER_MODE_REQ; // 0x00 – Sub-command: Bootl
...
bufferIO[5] = cmdSeqNo++;
bufferIO[6] = COMMAND_BOOTLOADER; // 0x0D – Bootloader command
bufferIO[7] = COMMAND_BOOTLOADER_STATUS_REQ; // 0x01 – Sub-command: Boo
if(waitForCommandResponse() == HAL_OK) {
return bootLoader.OperationMode;
}
return BootInvalid;
}
// The interactive calibration feature requires that the sensor hub be told
HAL_StatusTypeDef BNO_interactiveCalibration(const BNO_MotionIntent_t inten
resetHeader(REPORT_COMMAND_REQUEST);
bufferIO[5] = cmdSeqNo++;
bufferIO[6] = COMMAND_INTERACTIVE_CAL_REQ; // 0x0E – Interactive Calibr
bufferIO[7] = intent; // Motion intent
return sendPacket(CHANNEL_CONTROL);
}
#ifdef WHEEL_ENCODER
// Provide a single sample of wheel encoder data. No response is sent for t
HAL_StatusTypeDef BNO_WheelRequest(const uint8_t wheelIndex
resetHeader(REPORT_COMMAND_REQUEST);
bufferIO[5] = cmdSeqNo++;
bufferIO[6] = COMMAND_WHEEL_REQ; // 0x0F – Wheel Request
bufferIO[7] = wheelIndex; // Wheel Index (0 = Left Wheel, 1 = Right Whe
*(uint32_t *)&bufferIO[8] = timeStampUs; // The timestamp is a 32-bit u
*(int16_t *)&bufferIO[12] = wheelData; // The timestamp is a 32-bit uns
bufferIO[14] = dataType; // Data Type (0 = Position, 1 = Velocity)
return sendPacket(CHANNEL_CONTROL);
}
#endif
// This is sent from the host to the hub to trigger a flush of outstanding
...
// -X North, Y East, Z Up
if(BNO_TareSetReorientation(Q_FLIP, 0.0, 0.0, -Q_FLIP
...
if(BNO_condigureCalibration(CALIBRATE_ACCEL_GYRO_MAG)
if(BNO_setFeature(MAGNETIC_FIELD_CALIBRATED, 100000
if(BNO_setFeature(GAME_ROTATION_VECTOR, 100000
...
if (sensorData.sensorId == MAGNETIC_FIELD_CALIBRATE
...
// printf("GrvA=%d\r\n", grvA);  // Optional de
                        ...
                        sensorData.sensorId = 0; // Reset the sensor ID af
}
// If both magnetometer and rotation vector have maximu
if ((magA == 3) && (grvA == 3)) {
break;
}
}
...
BNO_Feature_t ret = {0};
bufferIO[5] = sensorID; // Feature Report ID. 0x01 = Accelerometer, 0x0
if(waitForCommandResponse() == HAL_OK) {
ret = sensorFeartures;
}
return ret;
...
resetHeader(REPORT_SET_FEATURE_COMMAND); // Set feature command. Refere
...
//*(uint16_t *)&bufferIO[7] = 0; // Change sensitivity [absolute | rela
*(uint32_t *)&bufferIO[9] = microsBetweenReports; // Report interval (L
...
return sensorData.SenVal.Pressure; // Atmospheric Pressure.  [hectopasc
}
#endif
#ifdef AMBIENT_LIGHT
...
return sensorData.SenVal.StepDetectorLatency; // Step detect latency [u
}
#endif
#ifdef STEP_COUNTER
...
#endif
#ifdef PERSONAL_ACTIVITY_CLASSIFIER
BNO_PersonalActivityClassifier_t getPersonalActivityClassifier
...
return sensorData.SenVal.HeartRateMonitor; // Heart rate in beats per m
}
#endif
Popular Articles
#ifdef ARVR_STABILIZED_RV
